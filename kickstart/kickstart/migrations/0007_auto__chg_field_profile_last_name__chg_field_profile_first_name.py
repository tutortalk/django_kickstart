...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'kickstart_profile', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Profile.first_name'
        db.alter_column(u'kickstart_profile', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.last_name'
        db.alter_column(u'kickstart_profile', 'last_name', self.gf('django.db.models.fields.CharField')(default='Last name', max_length=100))

        # Changing field 'Profile.first_name'
        db.alter_column(u'kickstart_profile', 'first_name', self.gf('django.db.models.fields.CharField')(default='First name', max_length=100))
    ...
    models = {
        ...
        u'kickstart.comment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 0, 0)'}),
