...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'kickstart_profile', 'about',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.balance'
        db.add_column(u'kickstart_profile', 'balance',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'kickstart_profile', 'about')

        # Deleting field 'Profile.balance'
        db.delete_column(u'kickstart_profile', 'balance')
