...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'kickstart', ['Project'])

        # Adding M2M table for field tags on 'Project'
        m2m_table_name = db.shorten_name(u'kickstart_project_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'kickstart.project'], null=False)),
            ('tag', models.ForeignKey(orm[u'kickstart.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'tag_id'])

        # Adding model 'Benefit'
        db.create_table(u'kickstart_benefit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'kickstart', ['Benefit'])

        # Adding model 'Tag'
        db.create_table(u'kickstart_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'kickstart', ['Tag'])


    def backwards(self, orm):
        # Deleting model 'Project'
        db.delete_table(u'kickstart_project')

        # Removing M2M table for field tags on 'Project'
        db.delete_table(db.shorten_name(u'kickstart_project_tags'))

        # Deleting model 'Benefit'
        db.delete_table(u'kickstart_benefit')

        # Deleting model 'Tag'
        db.delete_table(u'kickstart_tag')
